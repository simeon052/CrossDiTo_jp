...
void XtcReaderActivity::openReaderMenu() {
  ...
  startActivityForResult(
      makeUniqueNoThrow<XtcReaderMenuActivity>(renderer, mappedInput, xtc->getTitle(), hasChapters, stats.isCompleted),
...
void XtcReaderActivity::openChapterSelection() {
  ...
  startActivityForResult(makeUniqueNoThrow<XtcReaderChapterSelectionActivity>(renderer, mappedInput, xtc, currentPage),
                         [this](const ActivityResult& result) {
...
void XtcReaderActivity::openReadingStats() {
  ...
  if (hasSyncedStats) {
    ...
    startActivityForResult(
        makeUniqueNoThrow<BookStatsActivity>(renderer, mappedInput, xtc->getTitle(), xtc->getCachePath(), displayStats,
