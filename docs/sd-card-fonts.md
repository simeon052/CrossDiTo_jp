...
CrossDiTo supports loading additional fonts from the SD card, including fonts
...
1. Connect your CrossDiTo reader to Wi-Fi
...
1.  Download font files from the
    [CrossDiTo Fonts](https://github.com/uxjulia/crossink-fonts/tree/main/cpfonts) repository.
...
saved point size is no longer available, CrossDiTo chooses the closest file from
