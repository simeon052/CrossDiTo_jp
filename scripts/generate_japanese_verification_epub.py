...
<p>欧文にルビ　<ruby>PK<rt>プレイヤーキル</rt></ruby>と<ruby>Guild<rt>ギルド</rt></ruby>。
寝かせた欧文でも、ルビが親文字に重ならず右に出ていれば正しい。</p>

<p>欧文に<s>Strike</s>と<u>Under</u>。打ち消し線が列の中央、傍線が列の左を
通っていれば正しい。親文字が欧文でも位置は変わらない。</p>
""")
